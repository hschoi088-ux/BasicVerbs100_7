...
<body oncontextmenu="return false">
    ...
    <div class="max-w-md mx-auto px-4 py-6">
        ...
        <div class="flex space-x-2 mb-6 overflow-x-auto pb-2 no-scrollbar font-bold text-sm">
            ...
            <button onclick="selectWeek('total2')" id="tab-total2" class="week-tab flex-shrink-0 px-4 py-2 bg-white rounded-full shadow-sm border border-slate-100">W5-7 누적</button>
        </div>
    ...
    <script>
        const allData = [
            ...
            {d:5, s:"교재2", k:"오늘 바빠? 점 점심 먹자.", e:"Are you busy today? Let’s have lunch."},
        ...
        function selectWeek(mode) {
            ...
            else if(mode === 'total2') titleEl.innerText = "WEEK 5-7 (Month 2 Accumulated)";
        }
        ...
        function startQuiz(difficulty) {
            ...
            else if (selectedWeekMode === 'total2') weekFiltered = allData.filter(item => item.d >= 21 && item.d <= 35);
